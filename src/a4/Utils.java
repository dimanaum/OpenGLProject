...
public class Utils
{
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		gl.glTexStorage2D(GL_TEXTURE_CUBE_MAP, 1, GL_RGBA8, 1504, 1504);
		
		// attach the image texture to each face of the currently active OpenGL texture ID
		gl.glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, 0, 0, 1504, 1504,
				GL_RGBA, GL_UNSIGNED_BYTE, rightWrappedRGBA);		
		gl.glTexSubImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, 0, 0, 0, 1504, 1504,
				GL_RGBA, GL_UNSIGNED_BYTE, leftWrappedRGBA);
		gl.glTexSubImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, 0, 0, 1504, 1504,
				GL_RGBA, GL_UNSIGNED_BYTE, bottomWrappedRGBA);
		gl.glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 0, 0, 0, 1504, 1504,
				GL_RGBA, GL_UNSIGNED_BYTE, topWrappedRGBA);
		gl.glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 0, 0, 0, 1504, 1504,
				GL_RGBA, GL_UNSIGNED_BYTE, frontWrappedRGBA);
		gl.glTexSubImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, 0, 0, 1504, 1504,
	...
	// PURPLE material - ambient, diffuse, specular, and shininess
	public static float[] purpleAmbient()  { return (new float [] {0.34f,0.08f,0.65f,1.0f} ); }
	public static float[] purpleDiffuse()  { return (new float [] {0.1f,0.17f,0.37f,1.0f} ); }
	public static float[] purpleSpecular() { return (new float [] {0.16f,0.08f,0.32f,1.0f} ); }
	public static float purpleShininess()  { return 73f; }

//	// PURPLE material - ambient, diffuse, specular, and shininess
//	public static float[] purpleAmbient()  { return (new float [] {0.34f,0.08f,0.87f,1.0f} ); }
//	public static float[] purpleDiffuse()  { return (new float [] {0.1f,0.17f,0.37f,1.0f} ); }
//	public static float[] purpleSpecular() { return (new float [] {0.16f,0.08f,0.32f,1.0f} ); }
//	public static float purpleShininess()  { return 73f; }

//	// PURPLE material - ambient, diffuse, specular, and shininess
//	public static float[] purpleAmbient()  { return (new float [] {0.37f,0.08f,0.87f,1.0f} ); }
//	public static float[] purpleDiffuse()  { return (new float [] {0.53f,0.17f,0.69f,1.0f} ); }
//	public static float[] purpleSpecular() { return (new float [] {0.16f,0.08f,0.32f,1.0f} ); }
//	public static float purpleShininess()  { return 73f; }
	...
	public static float emeraldShininess()  { return 0.6f; }
